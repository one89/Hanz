						...
						<div class="col-lg-8 mb-5 mb-lg-0">
								...
								<div class="card bg-transparent border-0 custom-border-radius-1">
									<div class="card-body p-0 z-index-1">
										<a href="demo-education-blog-post.html" data-cursor-effect-hover="plus">
											<img class="card-img-top border-radius-0 mb-2" src="img/blog/wide/blog-2.jpg" alt="Card Image">
										</a>
							...
							<article class="mb-5">
								<div class="card bg-transparent border-0 custom-border-radius-1">
									<div class="card-body p-0 z-index-1">
										<a href="demo-education-blog-post.html" data-cursor-effect-hover="plus">
											<img class="card-img-top border-radius-0 mb-2" src="img/blog/wide/blog-21.jpg" alt="Card Image">
										</a>
										<p class="text-uppercase text-color-default text-1 my-2">
											<time pubdate datetime="2025-01-10">10 Jan 2025</time> 
											<span class="opacity-3 d-inline-block px-2">|</span> 
							...
							<aside class="sidebar">
								...
								<div class="px-3 mt-4">
									...
									<div class="pb-2 mb-1">
										...
										<a href="#" class="text-color-default text-2 mb-0 d-block text-decoration-none line-height-4">Admin on <strong class="text-color-secondary text-hover-primary text-4">Consectetur adipiscing</strong> <span class="text-uppercase text-1 d-block pt-1 pb-3">10 Jan 2025</span></a>
									</div>
								</div>
								<div class="py-1 clearfix">
									<hr class="my-2">
